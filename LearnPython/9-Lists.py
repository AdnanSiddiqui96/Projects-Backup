...
# Note: The length of the list will change when the
#  number of items inserted does not match the number of items replaced.
...
# which purpose is to add elements from one list to another list:
